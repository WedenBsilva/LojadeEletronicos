package com.mercadolibre.marketplace_nine.config;

import static com.mercadolibre.marketplace_nine.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.marketplace_nine.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("maulopes")
                .email("mauricio.lopes@mercadolivre.com"));
